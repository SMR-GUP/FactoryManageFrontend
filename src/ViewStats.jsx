...
const fetchEmployeeDetails = async (employeeId) => {
  try {
    const response = await axios.get(`https://factorymanagementserver.onrender.com/get/${employeeId}`);
...
const fetchAttendanceDetails = async (year, month, day) => {
  try {
    const response = await axios.get(`https://factorymanagementserver.onrender.com/getDayAttendance/${id}/${year}/${month}/${day}`);
...
const handleAddAttendance = async (e) => {
  ...
  try {
    ...
    const response = await axios.post(`https://factorymanagementserver.onrender.com/submitAttendance/${id}`, data);
...
const handleEditAttendance = async (e) => {
  ...
  try {
    ...
    const response = await axios.put(`https://factorymanagementserver.onrender.com/updateAttendance/${id}/${addDay}/${addMonth}/${addYear}`, data);
  ...
  useEffect(() => {
    axios.get(`https://factorymanagementserver.onrender.com/get/${id}`)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const response = await axios.get(`https://factorymanagementserver.onrender.com/getAttendance/${id}`, {
            params: {
              month: selectedMonth,
              year: selectedYear
            }
          ...
          const responseSalary = await axios.get(`https://factorymanagementserver.onrender.com/getSalary/${id}`);
